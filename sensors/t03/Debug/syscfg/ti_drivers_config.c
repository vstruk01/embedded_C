...
const I2C_Config I2C_config[CONFIG_I2C_COUNT] = {
    ...
    /* Sensors BoosterPack I2C */
    {
        ...
        .object      = &i2cCC26xxObjects[CONFIG_I2C_BMI],
        .hwAttrs     = &i2cCC26xxHWAttrs[CONFIG_I2C_BMI]
    },
};
...
const PIN_Config BoardGpioInitTable[] = {
    ...
    /* Sensors BoosterPack I2C, Parent Signal: CONFIG_I2C_BMI SDA, (DIO5) */
    CONFIG_PIN_2 | PIN_INPUT_EN | PIN_PULLDOWN | PIN_IRQ_DIS,
    /* Sensors BoosterPack I2C, Parent Signal: CONFIG_I2C_BMI SCL, (DIO4) */
    CONFIG_PIN_3 | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MED,
    /* Acc/Gyro Interrupt 1, Parent Signal: CONFIG_GPIO_BMI160_INT1 GPIO Pin, (DIO22) */
